...
public class HandlerProcessInsertVehicle implements HttpHandler  {
	...
	public void handle(HttpExchange he) throws IOException {
		...
		//get inputs to put into DAO Update Method
		//convert relevant strings to int
		...
		//updated vehicle to pass into method
		...
		try { 
			...
			dao.insertRecordIntoVehicles(Ins);
